...
<form action="index.php?controller=editor&action=expertinfoshow&f=expertSelect" method="post">
...
<table  cellpadding="0" cellspacing="0" class="showinfo">
  ...
  <?php
	for( $k=1, $i=$pageoffset+1;$i <= $pageoffset+$rownums ; $i++ ,$k++){
		...
		echo "<td align='center' > 
		<a href='index.php?controller=editor&action=expertdetail&f=oneExpertInfo&id=$exusername'> 查看详细</a> 
		</td>";
		echo "</tr>";
	}
?>
