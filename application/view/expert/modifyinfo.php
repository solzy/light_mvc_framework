...
<form action="index.php?controller=expert&action=modifyinfo&f=modifyInfo"method="post">
...
<tr >
	...
	<td width=450px>&nbsp;&nbsp;<input type="text" ignore="ignore"  value="" name="name" class="inputxt Validform_error" datatype="z2-4"  nullmsg="请输入中文名！" errormsg="中文名为2~4个中文字符！">
	</td>
