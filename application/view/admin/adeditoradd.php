...
<form action="index.php?controller=admin&action=adeditoradd&f=adeditorAdd" method="post">
  		  ...
  		  <td colspan=4 > 
    			<div class="buttonarea">
    				<button type='submit' >
    		 		...
    		 		<button type='button' >
					 <a href='index.php?controller=admin&action=adeditormanage&f=adeditorInfoM'> 返回 </a>
					 </button> 
    			</div>
 		   </td >
	  </tr>
