...
<form action="index.php?controller=admin&action=editoradd&f=editorAdd" method="post">
  		  ...
  		  <td colspan=4 > 
    			<div class="buttonarea">
    				<button type='submit' >
    		 		...
    		 		<button type='button' >
					 <a href='index.php?controller=admin&action=editormanage&f=editorInfoM'> 返回 </a>
					 </button> 
    			</div>
 		   </td >
	  </tr>
