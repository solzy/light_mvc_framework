...
<form action="index.php?controller=admin&action=writeradd&f=writerAdd" method="post">
  		  ...
  		  <td colspan=4 > 
    			<div class="buttonarea">
    				<button type='submit' >
    		 		...
    		 		<button type='button' >
					 <a href='index.php?controller=admin&action=writermanage&f=writerInfoM'> 返回 </a>
					 </button> 
    			</div>
 		   </td >
	  </tr>
