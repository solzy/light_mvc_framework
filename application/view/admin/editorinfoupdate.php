...
<form action="index.php?controller=admin&action=editorinfoupdate&f=modifyEditorInfo&id=<?php echo  $_GET['id'];?>" method="post">
...
<tr >
	...
	<td width=450px>&nbsp;&nbsp;<input type="text" ignore="ignore"  value='<?php echo $editorinfo[0]["name"];?>' name="name" class="inputxt Validform_error" datatype="z2-4"  nullmsg="请输入中文名！" errormsg="中文名为2~4个中文字符！">
	</td>
...
<span>联系方式修改</span>
    ...
    <td width=450px >&nbsp;&nbsp;<input type="text" value='<?php echo $editorinfo[0]['tel'];?>' name="tele" class="inputxt Validform_error" ignore="ignore" datatype="m" nullmsg="请填入信息！" errormsg="手机号码错误！"/></td>
	<td><div class="Validform_checktip "></div></td>
  </tr>
	<tr >
    <td class= "subtitle">邮箱</td >
    <td>&nbsp;&nbsp;<input type="text" value='<?php echo $editorinfo[0]['mail'];?>' name="email" class="inputxt Validform_error" datatype="e" ignore="ignore" 	nullmsg=“输入格式：nist@163.com" errormsg="输入错误！">	
	</td>
	<td><div class="Validform_checktip">输入格式：nist@163.com</div></td>
  </tr>
   <tr >
    <td class= "subtitle">住址</td >
   <td>&nbsp;&nbsp;<input type="text" value='<?php echo $editorinfo[0]['address'];?>' name="address" class="inputxt Validform_error"datatype="*0-15"ignore="ignore" nullmsg="字数小于20个" errormsg="">	
			</td>
