    ...
    <td valign=top align="left">
      ...
      <table id=child1 style="display: block" cellspacing=0 cellpadding=0 width=150px >
        <tr height=20px>
          ...
          <td ><a class="menuchild "  href="index.php?controller=writer&action=paperregister">我要投稿</a></td></tr>
        <tr height=20px>
          <td align="center" width=30px><img height=9px src=public/images/menu_icon.gif width=9px></td>
          <td><a class="menuchild" href="index.php?controller=writer&action=paperstatus&f=paperStatus" >稿件状态查询</a></td></tr>
         <tr height=4px>
          <td colspan=2></td></tr>
     </table>
       <table cellspacing=0 cellpadding=0 width="150px" >      
      ...
      <table id=child2 style="display: block" cellspacing=0 cellpadding=0 width=150px >
        <tr height=20px>
          <td align="center"width=30px><img height=9px src="public/images/menu_icon.gif " width=9px></td>
          <td ><a class="menuchild "  href="index.php?controller=writer&action=personalinfo&f=showPersonalInfo"
		  >查看个人信息</a></td></tr>
        <tr height=20px>
          <td align="center" width=30px><img height=9px src=public/images/menu_icon.gif width=9px></td>
          <td><a class=menuchild 	href="index.php?controller=writer&action=modifyinfo"
           >修改个人信息</a></td></tr>
         <tr height=4px>
          <td colspan=2></td></tr>
     </table>
	 <table id=child0 style="display: block" cellspacing=0 cellpadding=0 width=150px>  
        <tr height=20>
          ...
          <td><a class=menuchild  href="javascript:if(confirm('确实要退出系统吗?'))location='index.php?controller=writer&f=logout'"
           >退出系统</a></td></tr>
	</table>
		</td>
