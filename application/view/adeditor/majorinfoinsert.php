<form action="index.php?controller=adeditor&action=majorinfoinsert&f=majorInfoInsert" method="post">
...
<tr >
	...
	<td width=450px>&nbsp;&nbsp;<input type="text"  value="" name="majorid" class="inputxt Validform_error" datatype="n6-6"  nullmsg="请输入中文名！" errormsg="请输入由六位数字组成的编号！">
	</td>
  ...
  <tr >
    ...
    <td>&nbsp;&nbsp;<input type="text" ignore="ignore"  value="" name="majorname" class="inputxt Validform_error" datatype="*1-20"  nullmsg="请输入中文名！" errormsg="请输入由六位数字组成的编号！">
