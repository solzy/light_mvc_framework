...
<form action="index.php?controller=adeditor&action=expertupdate&f=modifyExpertInfo&id=<?php echo  $_GET['id'];?>" method="post">
...
<tr >
	...
	<td width=450px>&nbsp;&nbsp;<input type="text" ignore="ignore"  value='<?php echo $expertinfo[0]["name"];?>' name="name" class="inputxt Validform_error" datatype="z2-4"  nullmsg="请输入中文名！" errormsg="中文名为2~4个中文字符！">
	</td>
  ...
  <tr >
	...
	<td><div class="Validform_checktip"></div></td>
 	<tr>
		...
		<td>&nbsp;&nbsp;<select class="selectfield" ignore="ignore" name="field" datatype="*" nullmsg="请选择论文所属领域！"
			errormsg="请选择您所学的专业！">
			<option value="">请选择所属领域</option>
		</select></td>
		<td>
		<div class="Validform_checktip">选择所属领域</div>
		</td>
	</tr>
	 <tr>
    <td colspan=3 > 
...
<span>联系方式修改</span>
    ...
    <td width=450px >&nbsp;&nbsp;<input type="text" value='<?php echo $expertinfo[0]['tel'];?>' name="tele" class="inputxt Validform_error" ignore="ignore" datatype="m" nullmsg="请填入信息！" errormsg="手机号码错误！"/></td>
	<td><div class="Validform_checktip "></div></td>
  </tr>
	<tr >
    <td class= "subtitle">邮箱</td >
    <td>&nbsp;&nbsp;<input type="text" value='<?php echo $expertinfo[0]['mail'];?>' name="email" class="inputxt Validform_error" datatype="e" ignore="ignore" 	nullmsg=“输入格式：nist@163.com" errormsg="输入错误！">	
	</td>
	<td><div class="Validform_checktip">输入格式：nist@163.com</div></td>
  </tr>
   <tr >
    <td class= "subtitle">住址</td >
   <td>&nbsp;&nbsp;<input type="text" value='<?php echo  $expertinfo[0]['address'];?>' name="address" class="inputxt Validform_error"datatype="*0-15"ignore="ignore" nullmsg="字数小于20个" errormsg="">	
			</td>
