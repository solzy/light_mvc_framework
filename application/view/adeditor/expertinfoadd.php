...
<form action="index.php?controller=adeditor&action=expertinfoadd&f=expertAdd" method="post">
  		  ...
  		  <td colspan=4 > 
    			<div class="buttonarea">
    				<button type='submit' >
    		 		...
    		 		<button type='button' >
					 <a href='index.php?controller=adeditor&action=expertmanage&f=expertInfoM'> 返回 </a>
					 </button> 
    			</div>
 		   </td >
	  </tr>
