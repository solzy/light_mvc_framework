<form action="index.php?controller=adeditor&action=schoolinfoinsert&f=schoolInfoInsert" method="post">
...
<tr >
	...
	<td width=450px>&nbsp;&nbsp;<input type="text"  value="" name="schoolid" class="inputxt Validform_error" datatype="n4-4"  nullmsg="请输入学院编码！" errormsg="请输入由4位数字组成的编号！">
	</td>
  ...
  <tr >
    ...
    <td>&nbsp;&nbsp;<input type="text" ignore="ignore"  value="" name="schoolname" class="inputxt Validform_error" datatype="*1-20"  nullmsg="请输入学院名称！" errormsg="学院名称太长！">
